 ...
 */
public enum VideoRelated implements Connection {
    ALL("related", Video.class, VideoEndpoint.ID),
    ID(ALL.value + "/{0}", Video.class, VideoEndpoint.ID);
     ...
     */
    VideoRelated(String value, Class clazz, Endpoint parent) {
        this.value = value;
        this.clazz = clazz;
        this.parent = parent;
    }
